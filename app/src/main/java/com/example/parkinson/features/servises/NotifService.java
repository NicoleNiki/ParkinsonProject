...
public class NotifService extends Service implements NotifManger.NotifMangerInteface {
    ...
    private NotifManger notifManger;
    @Inject
    public NotifService(NotifManger notifManger){
